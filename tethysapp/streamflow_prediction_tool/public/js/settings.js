...
$(document).ready(function() { //once the document is loaded
    ...
    $('#submit-changes-settings').click(function(){
        ...
        var base_layer_id = checkInputWithError($('#base-layer-select'),safe_to_submit, true);
    ...
    $('#base-layer-select').on('select2:select', function() {
        var base_layer_id = $(this).val();
    ...
    $('#base-layer-select').trigger('select2:select');
});

...
##                #LOAD AHPS STATION
##                geoserver_info['ahps_station'] = {'name': watershed.geoserver_historical_flood_map_layer.name,
...
def add_data_store(request):        
    ...
    data_store_api_key_input = TextInput(display_text='Data Store API Key',
